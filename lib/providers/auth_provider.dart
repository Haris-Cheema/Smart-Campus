  ...
  Future<void> _ensureGoogleInitialized() async {
    if (!_googleInitialized) {
      await _googleSignIn.initialize(
        clientId:
            '84042858582-psgrj7f0n9ipjl62dttq73bcrkunihih.apps.googleusercontent.com',
        serverClientId:
            '84042858582-psgrj7f0n9ipjl62dttq73bcrkunihih.apps.googleusercontent.com',
      );
  ...
  Future<void> _loadOrCreateUserModel(User firebaseUser) async {
    try {
      ...
      try {
        ...
        debugPrint(
          'Firestore Sync Warning: $firestoreError. Using local data fallback.',
        );
        ...
        try {
          ...
          if (await file.exists()) {
            try {
              ...
              debugPrint(
                'Storage disabled or failed: $storageError. Using local path instead.',
              );
